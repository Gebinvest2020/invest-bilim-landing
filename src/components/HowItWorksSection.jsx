...
const steps = [
  ...
  },
  {
    ...
    desc: 'Наш менеджер свяжется с вами для уточнения деталей и ответа на вопросы.',
    color: '#c9a84c',
  },
  {
    icon: PlayCircle,
    step: '03',
    title: 'Получаете доступ к урокам',
    desc: 'После подтверждения вы получаете ссылку на видеоуроки.',
    color: '#4ecdc4',
  },
  {
    icon: GraduationCap,
    step: '04',
    title: 'Изучаете в своём темпе',
    desc: 'Смотрите материалы когда удобно — без дедлайнов и ограничений по времени.',
    color: '#a78bfa',
  },
]
