...
export default function FinalCTA({ onCTA, onLegal }) {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-slate-400 leading-relaxed text-base mb-8">
              Оставьте заявку, чтобы получить доступ к видеоурокам
              по основам инвестирования — без сложных терминов и без давления.
            </p>

            {/* Bullet points */}
            <div className="flex flex-col gap-3">
              {[
                '5 структурированных видеоуроков',
          ...
          <div className="rounded-2xl p-6 sm:p-8"
            ...
            <LeadForm onSuccess={() => {}} onLegal={onLegal} />
          </div>
        </div>
      </div>
    </section>
