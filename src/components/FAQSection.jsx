...
const faqs = [
  ...
  },
  {
    ...
    a: 'Оставьте заявку на сайте, указав имя и телефон. Наш менеджер свяжется с вами для уточнения деталей и предоставления доступа.',
  },
  {
    q: 'В каком формате проходит обучение?',
    a: 'Обучение проходит в формате видеоуроков. Вы смотрите материалы в удобное для вас время, в своём темпе, без дедлайнов.',
  },
]
