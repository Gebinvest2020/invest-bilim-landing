...
const faqs = [
  {
    q: 'Какие темы разбираются в видеоуроках?',
    a: 'В уроках рассматриваются основные направления инвестирования, отличие акций и облигаций, важные вопросы выбора и последовательность дальнейшего изучения.',
  },
  {
    q: 'Доступ к видеоурокам бесплатный?',
    a: 'Да, вводные видеоуроки доступны бесплатно после заполнения формы доступа.',
  },
  {
    q: 'Как получить доступ к урокам?',
    a: 'Заполните форму на сайте, указав имя и телефон. После отправки вы получите доступ к вводным видеоурокам программы.',
  },
  {
    q: 'Нужно ли иметь опыт или специальные знания?',
    a: 'Нет. Специальных знаний не требуется. Материалы начинаются с базовых понятий и разбираются последовательно.',
  },
  {
    q: 'Что будет после получения доступа?',
    a: 'После заполнения формы вы получите доступ к вводным видеоурокам. При необходимости специалист проекта сможет помочь с вопросами по программе и дальнейшему изучению материалов.',
  },
  {
    q: 'В каком формате проходит обучение?',
    a: 'Программа включает видеоуроки от Данияра Аманалиева, которые можно смотреть в удобное время. При необходимости специалист проекта может связаться с вами и ответить на вопросы о программе.',
  },
]
