...
const faqs = [
  ...
  },
  {
    ...
    a: 'Программа включает видеоуроки от Данияра Аманалиева и вводную консультацию по формату обучения от команды проекта. Смотрите материалы в своём темпе, без дедлайнов.',
  },
]
