...
const points = [
  {
    icon: Lightbulb,
    title: 'Понимание — основа осознанного подхода',
    desc: 'Прежде чем принимать любые финансовые решения, важно сначала сформировать базовое понимание темы.',
    color: '#c9a84c',
  },
  {
    icon: ShieldCheck,
    title: 'Знание рисков помогает избежать ошибок',
    desc: 'Многие ошибки новичков связаны с тем, что они недооценивают риски или не понимают, как они работают.',
    color: '#4ecdc4',
  },
  {
    icon: Clock,
    title: 'Постепенное изучение лучше спешки',
    desc: 'Финансовая грамотность строится медленно. Качественное обучение важнее быстрого результата.',
    color: '#a78bfa',
  },
]
        ...
        <div className="rounded-3xl p-8 sm:p-10 lg:p-14 overflow-hidden relative"
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium mb-5"
              ...
              Почему важно сначала учиться
            </div>

            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-5" style={{ letterSpacing: '-0.02em', maxWidth: '600px' }}>
              Инвестиции требуют{' '}
              <span className="gradient-text">понимания</span>
            </h2>

            <p className="text-slate-400 leading-relaxed text-base mb-10 max-w-2xl">
              Перед тем как принимать финансовые решения, важно разобраться в базовых понятиях, рисках
              и возможных сценариях. Обучение помогает подходить к теме спокойнее и осознаннее.
            </p>
